...
public interface FitnessService {
	 ...
	 * @param id the fitness activity's id
	 ...
	 * @param dateFrom <b>required</b> date from
	 * @param dateTo date to
	 * @return List of fitness activities
	 * @throws EndpointException
	 */
	public List<Fitness> findFitnessByDate(String dateFrom, String dateTo)throws EndpointException;
	
	/**
	 * Save a fitness activity
	 * @param fitness  the fitness activities that is going to be saved
	 * @param method indicates if the operation is a put or post
	 * @return a list of fitness activities endpoint
	 * @throws EndpointException
	 */
	public List<Fitness> saveFitness(List<Fitness> fitness, RequestMethod method)throws EndpointException;
}
