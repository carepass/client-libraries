...
@implementation HHSFDARecallsSearchResponse
...
-(HHSFDARecallsSearchResult *)searchResultObjectAtIndex:(int)index
{
    return (HHSFDARecallsSearchResult *)[searchResults objectAtIndex:index];
}
