...
@implementation HHSFDADrugsResourcesResponse
...
-(NSString *)resourceStringAtIndex:(int)index
{
    return (NSString *)[resources objectAtIndex:index];
}
...
-(NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Search Results: %@,", resources] autorelease]];
