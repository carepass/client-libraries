...
@implementation HHSFDADrugsResponse

@synthesize result;

-(id)init {
    if (self = [super init]) {
        result = [[HHSFDADrugsResult alloc] init];
    }
...
-(NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Search Results: %@,", result] autorelease]];
