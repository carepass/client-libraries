...
@implementation HHSClinicalTrialsSearchResponse

@synthesize searchResult;

-(id)init {
    if (self = [super init]) {
        searchResult = [[HHSClinicalTrialsSearchResult alloc] init];
    }
...
-(HHSClinicalTrialsResult *)clinicalTrialsObjectAtIndex:(int)index {
    return (HHSClinicalTrialsResult *)[searchResult.trials objectAtIndex:index];
}
...
-(NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Search Results: %@,", searchResult] autorelease]];
