...
@interface HHSFDADrugsAlternativesResponse : HHSResponse {
    HHSFDADrugsAlternativesResult *alternatives;
}
 ...
 */
@property (nonatomic, retain) HHSFDADrugsAlternativesResult *alternatives;
