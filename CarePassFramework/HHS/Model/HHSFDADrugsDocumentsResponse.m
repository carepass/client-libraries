...
@implementation HHSFDADrugsDocumentsResponse
...
-(HHSFDADrugsDocumentsResult *)documentObjectAtIndex:(int)index {
    return (HHSFDADrugsDocumentsResult *)[documents objectAtIndex:index];
}
...
-(NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Search Results: %@,", documents] autorelease]];
