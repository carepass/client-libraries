...
@interface HHSClinicalTrialsSearchResponse : HHSResponse {
    HHSClinicalTrialsSearchResult *searchResult;
}
 ...
 */
@property (nonatomic, retain) HHSClinicalTrialsSearchResult *searchResult;
