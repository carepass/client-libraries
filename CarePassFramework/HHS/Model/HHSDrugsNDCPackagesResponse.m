...
#import "HHSDrugsNDCPackagesResponse.h"

@implementation HHSDrugsNDCPackagesResponse

@synthesize searchResult;

-(id)init {
    if (self = [super init]) {
        searchResult = [[HHSDrugsNDCPackageResult alloc] init];
    }
...
-(NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Search Result: %@,", searchResult] autorelease]];
