...
#import "HHSDrugsSearchResponse.h"

@implementation HHSDrugsSearchResponse
...
-(HHSDrugsSearchResult *)searchResultObjectAtIndex:(int)index {
    return (HHSDrugsSearchResult *)[searchResults objectAtIndex:index];
}
...
-(NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[[NSString alloc] initWithFormat:@"Search Results: %@,", searchResults] autorelease]];
