...
#import "CPSyncFitActivitiesResponse.h"
#import "../../JSONKit.h"

@interface CPSyncFitActivitiesResponseUnmarshaller : NSObject {
    CPSyncFitActivitiesResponse *response;
}

+(CPSyncFitActivitiesResult *) parseJSON:(NSDictionary *)jsonObject;

@property (nonatomic, readonly) CPSyncFitActivitiesResponse *response;
